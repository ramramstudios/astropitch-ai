...
Per-phase log of what landed and what did not. Updated when a phase lands.
"Waived" means an acceptance check, validator, or suite the phase called for that this run did not complete, with why.

- **Audio stability** — companion to `research/audio-stability-plan.md`. Phases 1–6, below.
- **iOS App Store** — companion to `research/ios-app-store-plan.md`. At the end of this file; the fuller
  account, including the morning checklist, is `research/ios-overnight-status.md`.
